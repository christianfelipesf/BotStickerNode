...
<head>
    ...
    <style>
        ...
        #header img { width: 45px; height: 45px; border-radius: 50%; object-fit: cover; border: 2px solid var(--wa-green); }
        #header-info { flex: 1; }
        #header-info div:first-child { font-weight: bold; font-size: 18px; }
        #header-info div:last-child { font-size: 13px; color: var(--wa-green); font-weight: 500; }

        .theme-selector { display: flex; gap: 8px; }
        .theme-btn { 
            border: none; padding: 6px 12px; border-radius: 20px; cursor: pointer; font-size: 12px; font-weight: bold;
        ...
        @media (max-width: 768px) { #chat { padding: 15px; } }
        ...
        .msg.system-error { background-color: #ffdce0 !important; color: #86181d !important; align-self: center; border-radius: 8px; border: 1px solid #f1aeb5; max-width: 95%; }
        ...
        .msg.bot-action { background-color: #e7f3ff !important; color: #004085 !important; align-self: center; border-radius: 8px; border: 1px solid #b8daff; max-width: 95%; }
        ...
        .msg.member-event { background-color: #d4edda !important; color: #155724 !important; align-self: center; border-radius: 8px; border: 1px solid #c3e6cb; max-width: 95%; font-size: 13px; }
        ...
        .sender-info { display: flex; gap: 8px; align-items: baseline; margin-bottom: 2px; }
        .sender { font-size: 13px; font-weight: 700; cursor: pointer; }
        .phone { font-size: 11px; opacity: 0.7; }
        .group-name { 
            font-size: 11px; font-weight: bold; padding: 2px 6px; border-radius: 10px;
            background: rgba(0,0,0,0.05);
        }
        body.dark .group-name, body.oled .group-name { background: rgba(255,255,255,0.1); }

        .type-tag { font-size: 10px; text-transform: uppercase; padding: 1px 5px; border-radius: 4px; font-weight: 900; letter-spacing: 0.5px; }
        ...
        .time { font-size: 10.5px; opacity: 0.6; }

        .date-divider { 
            align-self: center; background: #e1f3fb; padding: 6px 14px; border-radius: 10px; 
            font-size: 12.5px; color: #54656f; margin: 15px 0; text-transform: uppercase; 
            box-shadow: 0 1px 1px rgba(0,0,0,0.1); font-weight: 500;
        }
...
<body class="dark">
    ...
    <div id="header">
        ...
        <div class="theme-selector">
            <button class="theme-btn btn-light" onclick="setTheme('light')">CLARO</button>
            <button class="theme-btn btn-dark" onclick="setTheme('dark')">ESCURO</button>
