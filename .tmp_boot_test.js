...
console.log('??  ' + config.botName.toUpperCase() + ' � v' + _utils.getVersion() + ' � Rein�cio #' + _restartNumber);
console.log('='.repeat(60));
...
console.log('  ?? dashboard    ' + (_dashOk ? '? m�dulo ok' : '? falhou') + ' na porta ' + config.dashboardPort);
...
console.log('  ?? sess�o       ' + (_sockDir === 'sim' ? '? salva' : '? QR necess�rio'));
