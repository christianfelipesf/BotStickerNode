...
(function (D) {
    ...
    const DOCS = {
        ...
        transcribeModel: 'Modelo cloud do !transcrever (ex.: whisper-large-v3-turbo). Vazio = padrao do provedor.',
        transcribeProvider: 'Provedor do !transcrever: auto|groq|openai|openrouter|local (auto = Groq > OpenAI > OpenRouter > offline).',
        transcribeLocalModel: 'Modelo offline do !transcrever: tiny|base|small (faster-whisper, padrao base).',
        transcribeMaxSeconds: 'Duracao maxima (s) aceita pelo !transcrever (padrao 600).',
        ...
        splashEnabled: 'Liga/desliga global do splash de curiosidades (anti-spam: 1x/6h + mín. 60 msgs).',
        splashInterval: 'Mínimo de mensagens para o splash aparecer (60-200, padrão 60).',
        splashWithImage: 'Envia o splash com card de imagem (true) ou só texto (false).',
        splashCooldownMs: 'Janela anti-spam entre dois splashes no mesmo grupo (ms, mín. 6h=21600000, máx. 24h).'
    };
